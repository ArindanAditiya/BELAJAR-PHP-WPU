...
if(isset($_POST["submit"])){
  if(update($_POST) > 0){
    ...
    alert_check_fail("diupadate", "update.php");
  }
}
  ...
  <body>
    ...
    <div class="container mt-5">
      <div class="card">
        <div class="card-body">
          <!-- Form goe""s here -->
          <form method="post" enctype="multipart/form-data" action="" class="row g-3">
            <div class="col-12">
              <label for="file" class="form-label">Ganti Gambar</label>
              <div class="d-flex">              
                <img src="<?= $siswa["foto"];?>" class="foto2" alt="...">
                <input name="foto" class="form-control" type="file" id="file">
              </div>
            </div>
            <div class="col-12">

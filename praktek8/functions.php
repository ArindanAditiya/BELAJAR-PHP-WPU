<?php
    ...
    //DELETE DATA AND IMAGE FILE________________________________________________________________________________________________________________
    function delete($id) {
        global $conn;
    ...
    // UPDATE________________________________________________________________________________________________________________
    ...
    // SEARCH______________________________________________________________
    ...
    // REGISTER______________________________________________________________
    function register($data){
        ...
        // cek informasi pasword
        if( $password !== $password2 ){
            echo"
                <script>
                    alert('Konfirmsi Passworda tidak sesuai');
                </script>";
            return false;          
        }
